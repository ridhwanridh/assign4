document.addEventListener('DOMContentLoaded', function() {
    ...
    const apiUrlLondon = `https://api.weatherapi.com/v1/current.json?key=${apiKey}&q=London&aqi=no`;
	const apiUrlNewYork = `https://api.weatherapi.com/v1/current.json?key=${apiKey}&q=New%20York&aqi=no`;
